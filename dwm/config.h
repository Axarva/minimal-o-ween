...
static const char normbordercolor[] = "#000000"; /* normal border colour */
static const char selbordercolor[] = "#000000"; /* selected border colour */
static const char *fonts[]          = { "Museo Sans:size=10", "JoyPixels:pixelsize=10", "monospace:size=10" };
...
static const char *colors[][3]      = {
	...
	[SchemeStatus]  = { "#b39873", col_black,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
        [SchemeTagsSel]  = { "#905438", col_black,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
        [SchemeTagsNorm]  = { "#b39873", col_black,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
